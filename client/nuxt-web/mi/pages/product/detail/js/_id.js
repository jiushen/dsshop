...
export default {
  ...
  methods: {
    ...
    //跳转到工作台
    toJump(id){
        let path = 'http://dsshop.test/oauth/authorize?client_id=4&redirect_uri=https%3A%2F%2Fwpa1.qq.com%2FNQY4CF1Z%3F_type%3Dwpa%26qidian%3Dtrue%26auth%3DcommonAuth'
        let pathTwo='response_type=code&scope=%2A&state=DdVUdF32xwRPU42hEDTfwAvVIoh21PeYsao6noAr'
        let href= `${path}&qidian_ex1=${id}&wpaShowItemId=123&${pathTwo}`;
