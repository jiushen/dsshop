...
Route::prefix('v' . config('dsshop.versions'))->namespace('v' . config('dsshop.versions'))->group(function () {
    ...
    Route::prefix('admin')->namespace('Admin')->middleware(['auth:api'])->group(function () {
        ...
        Route::get('member/detailByUserId', 'MemberController@detailByUserId')->name('admin.memberList')->middleware(['permissions:MemberList']);  //订单列表--通过uid查询
        ...
        Route::get('indent/listCartByUid', 'IndentController@listCartByUid')->name('admin.indentList')->middleware(['permissions:IndentList']);    //购物车列表--用户ID
